...
imgs_for_cut_dir = 'letters-detect/ruzhimmash/number'
...
for img in files:
    ...
    for i in range(3):
        ...
        cv2.imwrite('letters-detect/ruzhimmash/cuts/' + 'cut_' + str(cut_number) + '.jpg', letter_img)
        left_border = right_border
        right_border = left_border + int(2 * w / 5)